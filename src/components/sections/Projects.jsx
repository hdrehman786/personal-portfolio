    ...
    <section id="projects" className=" flex justify-center items-center py-6 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
         ...
         hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(50,130,246,0.1)]
          ">
            <h3 className=" text-xl mb-3 font-bold">Basic Weather App</h3>
            <p className=" text-gray-400 mb-3">A basic weather app which cover basic functionality of HTML CSS JAVASCRIPT and Fetch api</p>
            <div className=" flex flex-wrap gap-2">
            ...
            <div className=" flex justify-between underline items-center mt-4">
              <a href="https://all-assignment-javascript-2.vercel.app/weather%20app/index.html" className="text-blue-500 hover:text-blue-800 transition-colors">View Project</a>
            </div>
          </div>
          <div className=" p-6 rounded-xl border border-white/10 hover:-translate-y-1 transition-all
         hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(50,130,246,0.1)]
